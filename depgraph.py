...
GRAPH = {'aac_adtstoasc_bsf': {'select': ['adts_header']},
 ...
 'av1_vaapi_hwaccel': {'deps': ['vaapi',
                       ...
                       'select': ['av1_decoder']},
 'avcodec': {'deps': ['avutil'], 'select': ['null_bsf'], 'suggest': ['libm', 'stdatomic']},
 'avdevice': {'deps': ['avformat', 'avcodec', 'avutil'], 'suggest': ['libm', 'stdatomic']},
 ...
 'libshine_encoder': {'deps': ['libshine'], 'select': ['audio_frame_queue', 'mpegaudioheader']},
 ...
 'swresample': {'deps': ['avutil'], 'suggest': ['libm', 'libsoxr', 'stdatomic']},
